...
function reverseString(str) {
  ...
  function clickhandler(e) {
    ...
    output.style.border='0.2rem solid rgb(255, 251, 0)';
    ...
    if (bdayString !== "") {
      ...
      if (!isPalindrome) {
        ...
        {
          output.innerText = `The nearest Next palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`;
        }
      } else {
